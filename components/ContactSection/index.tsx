...
export default function ContactSection({ dictionary }: { dictionary?: any }) {
  ...
  return (
    <div className="w-full flex items-center justify-center">
      <div className="font-dosis lg:mx-12 max-w-full lg:max-w-[1024px] bg-black/75 pt-0 border-t-2 border-yellow-300 pb-36 lg:pb-12 text-xl flex flex-col items-center justify-center z-[600] relative">
